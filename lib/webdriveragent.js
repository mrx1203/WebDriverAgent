...
<<<<<<< HEAD
import { BOOTSTRAP_PATH, WDA_RUNNER_BUNDLE_ID, CARTHAGE_ROOT, WDA_RUNNER_APP } from './constants';
...
<<<<<<< HEAD
    ...
    const wdaBundlePath = await fs.walkDir(this.derivedDataPath, true, (item) => item.endsWith(WDA_RUNNER_APP));
    if (!wdaBundlePath) {
